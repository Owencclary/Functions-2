...
console.log(uniq(names, uniqArr => console.log(`The new names array with all the duplicate items removed is ${uniqArr}`)))
...
// CODE HERE
console.log(each(names, (item, index) => `The item at ${index} is ${item}`))
