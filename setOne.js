...
////////// PROBLEM 2 //////////
/*
Write a one line function (give a name of your choice) with an implicit return that when the function 
is invoked, it will print: 'The first parameter is [parameter1]. The second parameter is [parameter2]'.
*/
...
Then, outside of the greeting function, invoke the greeting function, passing in the value 
firstName and lastName of your choice, and a callback function that takes a parameter of fullName. 
...
greeting('Owen', 'Clary', (fullName) => console.log(`Hello my name is ${fullName}`))
// so fullName is getting saved to the output of the callback function?
...
// CODE HERE
pricesPlusTax(prices, (callBack) => console.log(`The new array plus tax = ${totalCost}`))
...
// CODE HERE
let multiplySix = multiplyingFactory(6)
...
*/
let multiplyThree = multiplyingFactory(3)
multiplyThree(12)
